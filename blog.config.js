...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 300, // 更新缓存间隔 单位(秒)；5分钟纯静态期，平衡内容更新时效性和访问速度
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MYAIGC', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '数字 baby', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://myaigc.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ai, aigc', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名工程师, Hi，我是一名自由职业者,Hi，我是一名数字游民,欢迎来到我的数字世界🎉',
